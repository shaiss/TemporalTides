...
- Cafés and shops (local, independent)
...
- Intellectual atmosphere (café debates)
...
- Flexible start times (9am ± 30 minutes accepted)
...
- Study in libraries, cafés (community integration)
...
- From medical model → social model (environment matters)
- From stigma → acceptance (ongoing work)
- From accommodation → celebration (not there yet, progress)
- From pathology → diversity (neurodiversity framework)
