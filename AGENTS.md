...
This file is the canonical project guidance for any coding agent (ZCode, Claude Code, and others). `CLAUDE.md` is a one-line pointer to this file; `.cursor/rules/*.mdc` carry Cursor-specific entry templates and style standards.
